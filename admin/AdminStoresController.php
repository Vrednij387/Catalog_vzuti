...
class AdminStoresControllerCore extends AdminController
{
    ...
    protected function _getDefaultFieldsContent()
    {
        ...
        $formFields = [
			...
			'SHOP_BANK_IBAN' => [
                'title' => $this->trans('Реквізит - IBAN', [], 'Admin.Global'),
                'validation' => 'isIban',
                'type' => 'text',
            ],
			'SHOP_BANK_NAME' => [
                'title' => $this->trans('Реквізит - Назва банку', [], 'Admin.Global'),
                'validation' => 'isGenericName',
                'type' => 'text',
            ],
			'SHOP_BANK_CODE' => [
                'title' => $this->trans('Реквізит - ЄДРПОУ', [], 'Admin.Global'),
                'validation' => 'isRegisterNumber',
                'type' => 'text',
				'maxlength' => 8,
            ],
			'SHOP_BANK_RECIPIENT' => [
                'title' => $this->trans('Реквізит - Отримувач', [], 'Admin.Global'),
                'validation' => 'isGenericName',
                'type' => 'text',
            ],
			'SHOP_BANK_ACTIVE' => [
                'title' => $this->trans('Реквізити On/Off', [], 'Admin.Global'),
                'validation' => 'isBool',
                'cast' => 'intval',
                'required' => false,
                'type' => 'bool'
            ],
			'SHOP_ORDER_CONFIRM_TEXT' => [
                'title' => $this->trans('Текст на сторінці подяка за замовлення', [], 'Admin.Global'),
                //'validation' => 'text',
                'type' => 'textarea',
            ],
        ];
