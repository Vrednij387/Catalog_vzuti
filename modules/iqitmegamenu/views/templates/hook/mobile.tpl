	<div id="_desktop_iqitmegamenu-mobile">
		<div id="iqitmegamenu-mobile"
			...
			<div class="mm-panel__header  mobile-menu__header-wrapper">
				...
				<a href="/">
					<img src="/themes/vzuti/assets/img/footer_logo.svg" alt="{l s='Vzuti'}" title="{l s='Vzuti'}">
				</a>
			...
			<div class="position-relative mobile-menu__content flex-grow-1 mx-c16 my-c24">
				<ul
					...
					<li class="cms-page"><a href="/content/1-pro_vtuti" title="{l s='Про нас'}">{l s='Про нас'}</a></li>
					<li class="cms-page"><a href="/content/2-dostavka" title="{l s='Умови оплати та доставки'}">{l s='Умови оплати та доставки'}</a></li>
					<li class="cms-page"><a href="/content/3-garantia" title="{l s='Обмін та повернення'}">{l s='Обмін та повернення'}</a></li>
					<li class="cms-page"><a href="/content/6-yak-obrati-rozmir" title="{l s='Як підібрати розмір'}">{l s='Як підібрати розмір'}</a></li>
					<li class="cms-page"><a href="/content/5-contacts" title="{l s='Контакти'}">{l s='Контакти'}</a></li>

					<li class="mobile-social">

						<a href="#" class="instagram" title="Instagram">
							<img src="https://vzutistore.com.ua/themes/vzuti/assets/img/insta.svg" alt="Наш інстаграм" title="Наш інстаграм">
						</a>
						<a href="#" class="telegram" title="Telegram">
							<img loading="lazy" src="https://vzutistore.com.ua/themes/vzuti/assets/img/telegram.svg"  alt="Наш телеграм бот" title="Наш телеграм бот">
						</a>
					</li>
				</ul>
			</div>
