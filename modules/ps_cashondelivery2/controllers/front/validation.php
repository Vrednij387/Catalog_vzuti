 ...
 */
class Ps_Cashondelivery2ValidationModuleFrontController extends ModuleFrontController
{
    /**
     * {@inheritdoc}
     */
    ...
    public function postProcess()
    {
        ...
        $this->module->validateOrder(
            ...
            (int) Configuration::getGlobalValue(Ps_Cashondelivery2::CONFIG_OS_CASH_ON_DELIVERY),
