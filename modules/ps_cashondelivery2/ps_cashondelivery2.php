...
class Ps_Cashondelivery2 extends PaymentModule
{
    const HOOKS = [
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->trans('Повна оплата за реквізитами', [], 'Modules.Cashondelivery.Admin');
    ...
    public function hookPaymentOptions(array $params)
    {
        ...
        $cashOnDeliveryOption->setCallToActionText($this->trans('Повна оплата за реквізитами', [], 'Modules.Cashondelivery.Shop'));
        $cashOnDeliveryOption->setAction($this->context->link->getModuleLink($this->name, 'validation', [], true));
        $cashOnDeliveryOption->setAdditionalInformation($this->fetch('module:ps_cashondelivery2/views/templates/hook/paymentOptions-additionalInformation.tpl'));
    ...
    public function hookDisplayOrderConfirmation(array $params)
    {
        ...
        return $this->fetch('module:ps_cashondelivery2/views/templates/hook/displayOrderConfirmation.tpl');
    }
    ...
    {
        if (Configuration::getGlobalValue(Ps_Cashondelivery2::CONFIG_OS_CASH_ON_DELIVERY)) {
            $orderState = new OrderState((int) Configuration::getGlobalValue(Ps_Cashondelivery2::CONFIG_OS_CASH_ON_DELIVERY));
        ...
        return $this->createOrderState(
            ...
            [
                ...
                'uk' => 'Очікується Повна оплата за реквізитами',
