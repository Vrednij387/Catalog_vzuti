...
class CreateproductsTabMEP extends BaseTabMEP
{
    ...
    public function apply()
    {
        ...
        foreach ($attributes as $attribute) {
            ...
            foreach ($language_ids as $id_lang) {
                ...
                $name[$id_lang] = $name_lang . (count($attribute) ? '-' . $attribute_group->name . ': ' . $attribute_obj->name[$id_lang] : '');
            }
            ...
            if (!$product->add()) {
                exit('An error occurred while creating an object.');
            }
    ...
    {
        return ['data-action' => 'create_products'];
    }
    ...
    public function renderFormCreateProducts()
    {
        ...
        $helper->tpl_vars = [
            'fields_value' => ['name' => $name, 'attribute' => ''],
            'languages' => $languages,
