...
class SmartyMEP
{
    protected static $cache_smarty_plugins = [];
    ...
    public static function registerSmartyFunctions()
    {
        ...
        self::registerFunction(
            'function',
            'get_image_lang',
            [__CLASS__, 'getImageLang']
        );
        self::registerFunction(
            'function',
            'renderTemplate',
            [__CLASS__, 'renderTemplate']
        );
        self::registerFunction(
            'function',
            'categoryImage',
            [__CLASS__, 'categoryImage']
        );
        self::registerFunction(
            'function',
            'versionCompare',
            [__CLASS__, 'versionCompare']
        );
        self::registerFunction(
            'modifier',
            'versionCompare',
            [__CLASS__, 'versionCompareModifier']
        );
        self::registerFunction(
            'modifier',
            'pluralForm',
            [__CLASS__, 'pluralForm']
        );
        if (class_exists('TransModMEP')) {
            self::registerFunction(
                'modifier',
                'ld',
                [TransModMEP::getInstance(), 'ld']
            );
        }
        self::registerFunction(
            'modifier',
            'dt',
            [__CLASS__, 'smartyDateFormatTranslate']
        );
