...
class ModuleAdminControllerMEP extends ModuleAdminController
{
    ...
    public function renderList()
    {
        if ($this->module->documentation) {
            ...
            return ToolsModuleMEP::fetchTemplate('admin/documentation_row.tpl') . parent::renderList();
        } else {
    ...
    public function renderView()
    {
        if ($this->module->documentation) {
            $this->assignModuleTabAdminLink();
            return ToolsModuleMEP::fetchTemplate('admin/documentation_row.tpl') . parent::renderView();
        } else {
    ...
    public function renderForm()
    {
        if ($this->module->documentation) {
            $this->assignModuleTabAdminLink();
            return ToolsModuleMEP::fetchTemplate('admin/documentation_row.tpl') . parent::renderForm();
        } else {
        ...
        if (array_key_exists('image', $this->fields_list)) {
            ...
            foreach ($this->_list as &$row) {
                $row['image'] = forward_static_call(
                    [$this->className, 'getObjectThumbnail'],
                    $row[$this->identifier],
