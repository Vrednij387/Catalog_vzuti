...
var tabsMEP = {
    ...
    'price': function () {
        $('#setPriceAllProduct').live('click', function () {
            ...
            data['price_whole'] = tab.find('[name="price_whole"]:checked').val();
        ...
        $('[name=type_price]').live('change', function () {
           var id_check = $(this).attr('id');
           if (id_check == 'type_price_wholesale') {
               $('#wholesale_block').css("display", "block");
           } else {
               $('#wholesale_block').css("display", "none");
           }
        ...
        $('#action_five').live('change', function () {
            $('.rounding-table tr').removeClass('active');
            $('.rounding-table tr.tr_five').addClass('active');
        });
    ...
    'supplier': function () {
        $('#setSupplierAllProduct').live('click', function () {
            ...
            data['suppliers_sr_price[]'] = tab.find('[name="suppliers_sr_price[]"]').val();
    ...
    'discount': function () {
        $('#setDiscountAllProduct').live('click', function () {
            ...
            data['sp_reduction_ai'] = tab.find('[name="sp_reduction_ai"]').val();
            data['sp_reduction_type_ai'] = tab.find('[name="sp_reduction_type_ai"]').val();
            data['sp_reduction_tax_ai'] = tab.find('[name="sp_reduction_tax_ai"]').val();
        ...
        $('#discount #off_menu').click(function () {
            $('#discount .edit_menu1').show();
            $('#discount .edit_menu2').hide();
    ...
    'rule_combination': function () {
        ...
        $('.addAttribute').live('click', function (e) {
            ...
            var attr_name = row_attributes.find('[name=attributes] option:selected').text();
    ...
    'meta': function () {
        ...
        $('#tags').closest('div').last().find('input').attr('name', 'tags');
        $('#setMetaAllProduct').live('click', function () {
            ...
            setTimeout(function () {
                ...
                data['category_redirect'] = $('.category_redirect').val();
                data['product_redirect'] = $('.product_redirect').val();
                data['tags'] = tags;
    ...
    'reference': function () {
        $('#setReferenceAllProduct').live('click', function () {
            var tab = $(this).closest('.tab_content');
            var data = {};
            data['set_unique_reference'] = (tab.find('[name=set_unique_reference]:checked').length ? 1 : 0);
    ...
    'quantity': function () {
        $('#setQuantityAllProduct').live('click', function () {
            ...
            data['location'] = tab.find('[name=location]').val();
            data['low_stock_threshold'] = tab.find('[name=low_stock_threshold]').val();
            data['low_stock_alert'] = tab.find('[name=low_stock_alert]:checked').val();
