...
// Feature search start
    $('#select_feature').live('click', function () {
    ...
    $('#select_feature').live('change', function () {
...
// Feature search end
    ...
    $("body").live('change', '#feature-val input[type=checkbox]', function () {
    ...
    $("body").live('change', '#feature-sel input[type=checkbox]', function () {
        var data_feature_values = $(this).attr("value");
    ...
    $('#select_attribute').live('click', function () {
    ...
    $('[name="attribute_group_main"]').live('change', function () {
    ...
    $("body").live('change', '[data-attribute-values] input[type=checkbox]', function () {
    ...
    $("body").live('change', '[data-attribute-values-view] input[type=checkbox]', function () {
        var data_attribute_values = $(this).attr("value");
...
$(document).ready(function () {
    ...
    $('.tabs_content').live('change', '[name="action_for_sp"]', function () {
    ...
    $('input[name="change_for"]').live('change', {
