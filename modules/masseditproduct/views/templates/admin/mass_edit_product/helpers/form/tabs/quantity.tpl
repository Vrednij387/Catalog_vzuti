...
{block name="form"}
    ...
    <!-- quantity tab -->
    <div class="row enabled_option_stage_static">
        <div class="float-left w-xs-100 {if $advanced_stock_management}_type type_quantity type_warehouse{/if}">
            <div class="col-sm-12 clearfix">
                <label class="control-label margin-right float-left pt-0 pt-sm-1">{l s='Apply change for' mod='masseditproduct'}:</label>
                <div class="ps-switch prestashop-switch fixed-width-xxl w-xs-100 switch-product-combination float-left">
        ...
        <div class="float-left {if $advanced_stock_management}_type type_quantity{/if}">
            <div class="col-sm-12 clearfix">
    ...
    {if $advanced_stock_management}
        <div class="row enabled_option_stage _type type_warehouse">
            <div class="col-lg-12 clearfix">
    ...
    {/if}
    <div class="row enabled_option_stage {if $advanced_stock_management}_type type_quantity type_warehouse{/if}">
    ...
    <div class="row enabled_option_stage">
        ...
        <div class="col-sm-12 clearfix form-group">
            <label class="control-label desc-label margin-right pt-0 pt-sm-1">{l s='Displayed text when in-stock' mod='masseditproduct'}:</label>
            <input class="control-label fixed-width-xl w-xs-100 form-control" type="text" name="available_now"/>
        </div>
    </div>
    <!-- --------------------------------------->
    <div class="row enabled_option_stage">
        ...
        <div class="col-sm-12 clearfix form-group">
            <label class="control-label desc-label margin-right pt-0 pt-sm-1">{l s='Displayed text when backordering is allowed' mod='masseditproduct'}:</label>
            <input class="control-label fixed-width-xl w-xs-100 form-control" type="text" name="available_later"/>
        </div>
    </div>
    <!------------------------------------------>
...
{*    </div>*}
    <div class="row enabled_option_stage">
        ...
        <div class="col-sm-12 clearfix">
            ...
            <div class="float-left">
                <label class="control-label desc-label margin-right float-left pt-0 pt-sm-1">{l s='Availability date' mod='masseditproduct'}:</label>
                <span class="ps-switch prestashop-switch fixed-width-xxxl switch-product-combination margin-right float-left form-group">
                    {foreach [0,1] as $value}
            ...
            <div class="float-left w-xs-100 form-group">
                <input type="text" class="datepicker fixed-width-xl w-xs-100 margin-right form-control" name="available_date"/>
            </div>
    ...
    <div class="row enabled_option_stage">
        ...
        <div class="col-sm-12">
            <div id="when_out_of_stock" class="">
                <div class="col-sm-12">

                    <label class="control-label margin-right float-left pt-0 pt-sm-1">{l s='When out of stock' mod='masseditproduct'}:</label>

                    <div class="form-group float-left margin-right">

                        <p class="radio form-check form-check-radio margin-right w-xs-100">
                            <label id="label_out_of_stock_1" class="form-check-label control-label" for="out_of_stock_1">
                        ...
                        <p class="radio form-check form-check-radio margin-right w-xs-100">
                            <label id="label_out_of_stock_2" class="form-check-label control-label" for="out_of_stock_2">
                        ...
                        <p class="radio form-check form-check-radio w-xs-100">
                            <span style="display: flex; flex-wrap: wrap;">
                                <label id="label_out_of_stock_3" class="form-check-label control-label margin-right" for="out_of_stock_3">
                                ...
                                <a class="confirm_leave w-xs-100 control-label text-left" href="index.php?tab=AdminPPreferences&token=&amp;token={$token_preferences|no_escape}">
    ...
    <div class="row enabled_option_stage">
        <span class="md-checkbox disable_option_wrap">
            <label>
                <input checked type="checkbox" name="disabled[]" value="location" class="disable_option">
                <i class="md-checkbox-control"></i>
            </label>
        </span>
        <div class="col-sm-4 form-group">
            <label class="control-label margin-right pt-0">{l s='Stock location' mod='masseditproduct'}:</label>
            <input class="form-control" type="text" name="location" value=""/>
        </div>
        <div class="col-sm-4 form-group">
            <label class="control-label margin-right pt-0">{l s='Low stock level' mod='masseditproduct'}:</label>
            <input class=" form-control" type="text" placeholder="{l s='Leave empty to disable' mod='masseditproduct'}" name="low_stock_threshold" value=""/>
        </div>
    </div>
    <div class="row enabled_option_stage">
        <span class="md-checkbox disable_option_wrap">
            <label>
                <input checked type="checkbox" name="disabled[]" value="low_stock_alert" class="disable_option">
                <i class="md-checkbox-control"></i>
            </label>
        </span>
        <div class="col-sm-12 form-group">
            <div class="md-checkbox">
                <label class="control-label">
                    <input class=" form-control" type="checkbox" name="low_stock_alert" style="width: 20px" value="1"/>
                    <i class="md-checkbox-control"></i>
                    {l s='Send me an email when the quantity is below or equals this level' mod='masseditproduct'}
                </label>
            </div>
        </div>
    </div>
