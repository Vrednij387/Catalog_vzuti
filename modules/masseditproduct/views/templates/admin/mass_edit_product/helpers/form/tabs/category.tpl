...
{block name="form"}
    ...
    <div class="row">
        <div class="col-sm-12 clearfix">
            <label class="control-label margin-right float-left w-100 pt-0">{l s='Action with categories' mod='masseditproduct'}:</label>
            <span class="ps-switch prestashop-switch fixed-width-400 float-left mt-0">
    ...
    <div class="row categories-block" id="inclusive_cat">
    ...
    <div class="row _action _action_add">
        <div class="col-sm-12 clearfix">
            ...
            <select class="fixed-width-lg w-xs-100 margin-right custom-select form-group" name="category_default"></select>
