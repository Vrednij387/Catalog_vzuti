...
{/literal}
    <div class="row disabled_option_stage enabled_option_stage">
        ...
        <div class="col-sm-12">
            <div class="row">
                <div class="col-sm-12">
                    <div class="float-left">
                        <label class="apply_change margin-right control-label float-left pt-0 pt-sm-1">{l s='Apply change for' mod='masseditproduct'}:</label>
            ...
            <div class="row" id="wholesale_block" style="display: none">
                <div class="col-sm-12">
                    <label class="control-label margin-right float-left">{l s='Расчитать цены?' mod='masseditproduct'}:</label>
                    <div class="btn-group btn-group-radio float-left">
                        <label for="wholesale">
                            <input type="radio" checked name="price_whole" value="0" id="wholesale"/>
                            <span>{l s='No' mod='masseditproduct'}</span>
                        </label>
                        <label for="base_wholesale">
                            <input type="radio" name="price_whole" value="1" id="base_wholesale"/>
                            <span>{l s='Base' mod='masseditproduct'}</span>
                        </label>
                        <label for="final_wholesale">
                            <input type="radio" name="price_whole" value="2" id="final_wholesale"/>
                            <span>{l s='Final' mod='masseditproduct'}</span>
                        </label>
                    </div>
                </div>
    ...
    <div class="row disabled_option_stage enabled_option_stage">
        ...
        <div class="col-sm-12 clearfix">
            <label class="control-label tax_rule margin-right float-left w-xs-100">{l s='Tax rule group' mod='masseditproduct'}:</label>
            <div class="float-left w-xs-100">
                <select class="fixed-width-xl w-xs-100 margin-right custom-select" name="id_tax_rules_group"
    ...
    <div class="row disabled_option_stage enabled_option_stage">
        ...
        <div class="col-sm-12 clearfix">
            <label class="control-label float-left margin-right pt-0 pt-sm-1" for="unit_price"
            ...
            <div class="input-group float-left fixed-width-xl form-group w-xs-100">
            ...
            <div class="input-group float-left fixed-width-xl w-xs-100 form-group">
    ...
    <!---- round ---->
    <div class="row disabled_option_stage enabled_option_stage form-group" id="price_round">
        <span class="md-checkbox disable_option_wrap">
            <label>
        ...
        <div class="col-sm-12">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-12">
                        <label class="control-label margin-right float-left pt-1 pt-sm-0">{l s='Rounding only for products without combinations' mod='masseditproduct'}   </label>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    <div class="col-sm-12">
                        ...
                        <div class="btn-group btn-group-radio float-left">
                            ...
                            <label for="action_five">
                                <input type="radio" name="action_rounding_value" value="5" id="action_five"/>
                                <span>5</span>
                            </label>
            ...
            <h3 id="title_edit_tabs" class="panel-heading text-center mb-0" style="display: block;">{l s='Rounding Examples' mod='masseditproduct'}</h3>
            ...
            <div class="row form-group">
                <div class="col-sm-12">
                    <table class="table-new rounding-table" id="in_large">
                        ...
                        <tr class="tr_five">
                            <td>823.783</td>
                            <td>{l s='rounding' mod='masseditproduct'} 5</td>
                            <td>825</td>
                        </tr>
                        <tr class="tr_one">
                            <td>823.783</td>
                    ...
                    <table class="table-new rounding-table" id="automatically" style="display: none">
                        ...
                        <tr class="tr_five">
                            <td>823.783</td>
                            <td>{l s='rounding' mod='masseditproduct'} 5</td>
                            <td>7 > 5 {l s='rounding up' mod='masseditproduct'} 825</td>
                        </tr>
                        <tr class="tr_one">
                            <td>823.783</td>
                            <td>{l s='rounding' mod='masseditproduct'} 1</td>
                            <td>7 > 5 {l s='rounding up' mod='masseditproduct'} 824</td>
                        </tr>
                        <tr class="tr_one_tenth">
                            <td>823.783</td>
                            <td>{l s='rounding' mod='masseditproduct'} 0.1</td>
                            <td>8 > 5 {l s='rounding up' mod='masseditproduct'} 823.8</td>
                        </tr>
                        <tr class="tr_one_cell">
                            <td>823.783</td>
                            <td>{l s='rounding' mod='masseditproduct'} 0.01</td>
