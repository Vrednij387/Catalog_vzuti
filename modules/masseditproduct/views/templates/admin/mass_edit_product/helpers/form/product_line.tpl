...
<tr class="product_{$product.id_product|intval}">
    ...
    {if !empty($product.log_on)}
		<td class="product_log">{$product.date_upd|escape:'quotes':'UTF-8'}</td>
		<td class="product_log">{$product.message|escape:'quotes':'UTF-8'}</td>
		<td class="product_log">{$product.employee|escape:'quotes':'UTF-8'}</td>
    {/if}
	...
	<td data-supplier class="center">{$product.supplier|escape:'htmlall':'UTF-8'}</td>
	...
	<td data-stock_management class="center">
