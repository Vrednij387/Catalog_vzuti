...
{block name="form"}
        ...
        <div id="features" class="">
            <div id="features-content" class="content">
                ...
                <div class="form_switch_language form-group float-left">
                    <select id="form_switch_language" class="custom-select fixed-width-sm">
            ...
            <div class="row form-group">
                <div class="col-md-4">
                    <button type="button" class="btn btn-default sensitive add" id="add_feature_button"><i class="material-icons">add_circle</i> {l s='Add a feature' mod='masseditproduct'}</button>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <span class="md-checkbox">
                        <label>
                            <input type="checkbox" name="old_feature_delete">
                            <i class="md-checkbox-control"></i>
                            {l s='To remove old features' mod='masseditproduct'}
                        </label>
                    </span>
                </div>
            </div>
    ...
    {else}
        ...
        <div class="list_features form-group">
