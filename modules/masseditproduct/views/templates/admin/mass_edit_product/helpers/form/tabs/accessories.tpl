...
{block name="form"}
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="select_products">
                <div class="search_row">
                    <div class="col-sm-12">
                        ...
                        <div class="float-left w-xs-100">
                            <div class="ps-switch prestashop-switch fixed-width-400 d-block float-left w-xs-100 switch-product-combination">
                ...
                <div class="search_row">
                    ...
                    <div class="right_column col-sm-6 form-group">
                        <label class="control-label pt-0 pt-sm-1">{l s='Selected' mod='masseditproduct'}:</label>
            ...
            <div class="remove-old form-group">
                <div class="col-sm-12">
                    <!-- Remove old? -->
