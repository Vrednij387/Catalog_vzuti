...
{block name="form"}
    <div class="row enabled_option_stage_static">
        <div class="col-sm-12 clearfix">
            <label class="control-label margin-right float-left pt-0 pt-sm-1">{l s='Select language' mod='masseditproduct'}:</label>
    ...
    <div class="row enabled_option_stage">
        ...
        <div class="col-sm-12">
            <label class="control-label label-meta margin-right pt-0 pt-sm-1">{l s='Meta title' mod='masseditproduct'}:</label>
    ...
    <div class="row enabled_option_stage">
        ...
        <div class="col-xs-12">
            <label class="control-label label-meta margin-right pt-0 pt-sm-1">{l s='Meta description' mod='masseditproduct'}:</label>
    ...
    <div class="row enabled_option_stage">
        ...
        <div class="col-sm-12 clearfix">
            <label class="control-label label-metat margin-right float-left pt-0 pt-sm-1">{l s='Tags' mod='masseditproduct'}:</label>
        ...
        <div class="col-sm-12">
            {renderTemplate file="admin/mass_edit_product/helpers/form/row_variables_tag.tpl" v=['name'=>'tags']}
        </div>
    </div>
  <div class="row enabled_option_stage">
      <span class="md-checkbox disable_option_wrap">
    ...
    <div class="col-xs-12 form-group">
      <label class="control-label label-meta margin-right pt-0 pt-sm-1">{l s='Chpu' mod='masseditproduct'}:</label>
  ...
  <div class="row enabled_option_stage form-group">
    ...
    <div class="col-xs-12">
      <label class="control-label label-meta margin-right pt-0">{l s='Redirection page' mod='masseditproduct'}:</label>
    </div>
