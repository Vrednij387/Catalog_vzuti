...
{foreach from=$languages item=language}
	...
	<div class="float-left margin-right translatable-field lang-{$language.id_lang|intval}">
	...
	{/if}
		...
		<div class="input-group">
			...
			value="{if !empty($input_value[$language.id_lang])}{$input_value[$language.id_lang]|htmlentitiesUTF8|default:''|escape:'quotes':'UTF-8'}{else}""{/if}"
