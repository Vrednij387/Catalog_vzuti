...
<div class="col-xs-12">
	...
	<table class="table-new">
		...
		<tr class="table_head">
			<th class="center">
				<span class="ps-sortable-column title_box" data-orderby="id_product" >{l s='ID' mod='masseditproduct'}
					<a class="ps-sort" href="#" data-orderway="ASC"></a>
				</span>
			</th>
			<th class="center">{l s='Image' mod='masseditproduct'}</th>
			<th class="center">
				<span class="ps-sortable-column title_box" data-orderby="name">{l s='Name' mod='masseditproduct'}
					<a class="ps-sort" href="#"  data-orderway="ASC"></a>
				</span>
			</th>

            {if !empty($product.log_on)}
				<th class="center">
					<span class="title_box">
                        {l s='Last edit' mod='masseditproduct'}
					</span>
				</th>
				<th class="center">
					<span class="title_box">
                        {l s='Message' mod='masseditproduct'}
					</span>
				</th>
				<th class="center">
					<span class="title_box">
                        {l s='Employee' mod='masseditproduct'}
					</span>
				</th>
            {/if}

			<th class="center">
				<span class="ps-sortable-column title_box" data-orderby="reference">{l s='Reference' mod='masseditproduct'}
					<a class="ps-sort" href="#"  data-orderway="ASC"></a>
				</span>
			</th>
			<th class="center">
				<span class="ps-sortable-column title_box" data-orderby="category">{l s='Category default' mod='masseditproduct'}
					<a class="ps-sort" href="#"  data-orderway="ASC"></a>
				</span>
			</th>
			<th class="center">
				<span class="ps-sortable-column title_box" data-orderby="price">{l s='Price' mod='masseditproduct'}
					<a class="ps-sort" href="#"  data-orderway="ASC"></a>
				</span>
			</th>
			<th class="center">{l s='Price final' mod='masseditproduct'}</th>
			<th class="center">
				<span class="ps-sortable-column title_box" data-orderby="manufacturer">{l s='Manufacturer' mod='masseditproduct'}
					<a class="ps-sort" href="#"  data-orderway="ASC"></a>
				</span>
			</th>
			<th class="center">{l s='Supplier' mod='masseditproduct'}</th>
      {*<th>{l s='Carrier' mod='masseditproduct'}</th>*}
			<th class="center">
				<span class="ps-sortable-column title_box" data-orderby="quantity">{l s='Quantity' mod='masseditproduct'}
					<a class="ps-sort" href="#"  data-orderway="ASC"></a>
				</span>
			</th>
			<th class="center">{l s='Stock management' mod='masseditproduct'}</th>
			<th class="center">{l s='Active' mod='masseditproduct'}</th>
			<th class="center" data-combinations>
