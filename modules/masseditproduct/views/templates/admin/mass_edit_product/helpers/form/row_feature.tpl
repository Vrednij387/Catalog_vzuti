...
<div class="row enabled_option_stage">
    <span class="ps-switch prestashop-switch fixed-width-xl">
                {foreach [0,1] as $value}
                    <input type="radio" name="disabled[feature][{$feature.id_feature|intval}]" value="{if $value == 1}{$feature.id_feature|escape:'html':'UTF-8'}{else}{$value|escape:'quotes':'UTF-8'}{/if}" class="disable_option"
    ...
    <div class="col-sm-2 clearfix form-group">
    ...
    <div class="col-sm-6 clearfix form-group {if $smarty.const._PS_VERSION_ < 1.6}translatable{/if}">
