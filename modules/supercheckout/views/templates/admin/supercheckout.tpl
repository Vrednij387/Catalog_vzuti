                                                                    ...
                                                                    <select name="velocity_supercheckout[banner_country][]" id="banner_country" multiple>
                                                                        {foreach from=$active_countries key='k' item='v'}
                                                                            {if in_array($v['id_country'],$banner_countries)}
                                                                                <option value="{$v['id_country']}" selected>{$v['name']}</option>
                                                                            {else}
                                                                ...
                                                                <div id="facebook_accordian" class="accordian_container">
                                                                    ...
                                                                    <div class="accdiv">
                                                                        ...
                                                                        *}
                                                                        ...
                                                                        <br/> {$module_url|escape:'html':'UTF-8'}{if $module_url|strstr:'?'}&{$login_param}{else}?{$login_param}{/if}                                                                      
                                                                        </pre>
                                                                ...
                                                                <div id="google_accordian" class="accordian_container">
                                                                    ...
                                                                    <div class="accdiv">
                                                                        ...
                                                                        *}
                                                                        ...
                                                                        <pre><b>{l s='Use Authorized javascript origins: ' mod='supercheckout'}</b>{$current_domain|escape:'htmlall':'UTF-8'}</b></br><b>{l s='Use Authorized Redirect Url: ' mod='supercheckout'}</b>{$module_url|escape:'html':'UTF-8'}{if $module_url|strstr:'?'}&{$login_param}{else}?{$login_param}{/if}</pre>
                                                                ...
                                                                <div id="paypal_accordian" class="accordian_container">
                                                                    ...
                                                                    <div class="accdiv">
                                                                        ...
                                                                        *}
                                                                        ...
                                                                        <pre><b>{l s='For Step #9 Use Return Url: ' mod='supercheckout'}</b>{$module_url|escape:'html':'UTF-8'}{if $module_url|strstr:'?'}&{$login_param}{else}?{$login_param}{/if}</pre>
                                                            ...
                                                            {foreach from=$payment_methods item="pay_methods"}
                                                                ...
                                                                <div class="accdiv-logo">
                                                                    <table class="form">
																		...
																		<tr>
                                                                            <td class="name vertical_top_align"><span>{l s='Description' mod='supercheckout'}: </span>                                                                
                                                                                <i class="icon-question-sign supercheckout-tooltip-color" data-toggle="tooltip"  data-placement="top" data-original-title="{l s='Enter payment method title' mod='supercheckout'}"></i>
                                                                            </td>
                                                                                ...
                                                                                <table class="lang-title">
                                                                                    {foreach from=$languages item='lang'}
																						...
																						<tr>
                                                                                            ...
                                                                                            <td><div class="span6">
                                                                                                    <input type="text" class="text-width" name="velocity_supercheckout_payment[payment_method][{$pay_methods['id_module']|intval}][description][{$lang['id_lang']|intval}]" value="{if isset($velocity_supercheckout_payment['payment_method'][{$pay_methods['id_module']|intval}]['description'][{$lang['id_lang']|intval}])}{$velocity_supercheckout_payment['payment_method'][{$pay_methods['id_module']|intval}]['description'][{$lang['id_lang']|intval}]}{/if}"/>
