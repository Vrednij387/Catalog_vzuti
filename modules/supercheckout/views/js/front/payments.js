...
//        payment = $('input[name="stripe-payment-method"]', $form).val();
        ...
        // changes done by kanishka to modify stripe patch
        if (payment === undefined && ($('input:radio[name="payment_method"]:checked').attr('data-module-name') == 'stripe_official')) {
            payment = $("[name='stripe-payment-method']").val();
        }
        // changes done by kanishka to modify stripe patch
