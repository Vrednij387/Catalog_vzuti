...
class ManufacturerControllerCore extends ProductListingFrontController
{
    ...
    protected function assignManufacturer()
    {
        ...
        $manufacturerVar['logoLink'] = $this->context->link->getManufacturerImageLink($this->manufacturer->id);
    ...
    public function getTemplateVarManufacturers()
    {
        ...
        foreach ($manufacturers as $manufacturer) {
            ...
            $manufacturers_for_display[$manufacturer['id_manufacturer']]['image'] = $this->context->link->getManufacturerImageLink($manufacturer['id_manufacturer'], 'stores_default');
