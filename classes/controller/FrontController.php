...
class FrontControllerCore extends Controller
{
    ...
    protected function assignGeneralPurposeVariables()
    {
		...
		$cms = new CMS(9, $this->context->language->id, $this->context->shop->id); // for header info
        ...
        $templateVars = [
            ...
            'debug' => _PS_MODE_DEV_,
			'cms_9' => (int)$cms->active ? $cms->content : false,
        ];
        //echo(round((microtime(true) - $time_pre), 4)." sec<hr>");
        //exit($time_pre);
    ...
    public function setMedia()
    {
        ...
        $this->registerStylesheet('theme-customer', '/assets/css/customer.css', ['media' => 'all', 'priority' => 10]);
