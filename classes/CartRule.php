...
class CartRuleCore extends ObjectModel
{
    ...
    // ADDED внвнвн
    /** @var int|bool */
    public $show_banner = 0; // зезрз╒з╤ПзЇз▐зр зсзрз▌з╓ з╒з▌зё з▀з╤зъзрз╘зр "зфзхз▐з╥з▌з╓зтз╤"
    // ADDED ^^^
    public $date_add;
    public $date_upd;
    ...
    public static $definition = [
        ...
        'fields' => [
            ...
            // ADDED внвнвн
            'show_banner' => ['type' => self::TYPE_INT, 'validate' => 'isUnsignedId', 'required' => false],
            // ADDED ^^^
