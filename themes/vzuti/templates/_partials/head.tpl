...
{/block}
<meta name="google-site-verification" content="IQdElytgyqBCCjtvU5ZUC4jrcG1fKUNWoWl3xB1dSqE" />
<meta name="google-site-verification" content="gsDrwmF9PkgLz9qtvFq3vvuOsqUPfxGmGw_BkoT11W4" />

{block name='head_gtag'}

  {if isset($iqitTheme.codes_gtag) && $iqitTheme.codes_gtag && false}
...
{block name='head_seo'}
  ...
  <meta name="keywords" content="{block name='head_seo_keywords'}{$page.meta.keywords}{/block}">
    {if $page.page_name == "category"}
      ...
      {elseif (isset($smarty.get.q) && $smarty.get.q != "")}
        <meta name="robots" content="noindex, follow">
      {else}
  ...
  {block name='head_seo_canonical'}
	...
	{/if}
	<link rel="canonical" href="https://{$smarty.server.HTTP_HOST}{strtok($smarty.server.REQUEST_URI, '?')}">
  {/block}
...
{block name='head_ga'}
	{include file="_partials/head_ga.tpl"}
{/block} 
