    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <span class="modal-title">{l s='Переглянути фото' d='Shop.Theme.Catalog'}</span>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true"><img src="/themes/vzuti/assets/img/close.svg" alt="Закрити" title="Закрити"></span>
                </button>
            </div>
            <div class="modal-body">
                ...
                {if $product.cover}   
                    <a href="{if !empty($product.default_image.bySize.large_default.sources.webp)}{$product.default_image.bySize.large_default.sources.webp}{elseif !empty($product.default_image.bySize.large_default.sources.avif)}{$product.default_image.bySize.large_default.sources.avif}{else}{$product.default_image.bySize.large_default.url}{/if}" 
                        class="js-modal-product-cover-easyzoom" rel="nofollow {$product.default_image.bySize.large_default.sources.webp}">
                    <picture>
                                ...
                                {foreach from=$product.images item=image}
                                    <div class="swiper-slide">
                                        <div class="thumb-container">
                                            ...
                                            <img data-image-large-src="{if !empty($image.large.sources.webp)}{$image.large.sources.webp}{elseif !empty($image.large.sources.avif)}{$image.large.sources.avif}{else}{$image.large.url}{/if}" class="thumb js-modal-thumb img-fluid swiper-lazy"
