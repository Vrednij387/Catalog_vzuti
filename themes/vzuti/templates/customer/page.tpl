...
{block name='page_content_container'}
  <section id="content" class="page-content my-account-page-content-wrapper">
    ...
    {block name='my_account_side_links'}
      ...
      <div class="my-account-side-links col-sm-2">
        ...
        <a class="col-lg-4 col-md-6 col-sm-6 col-xs-12" id="wishlist-link" href="/module/iqitwishlist/view">
            <span class="link-item">
              {l s='Збережені товари' d='Shop.Theme.Customeraccount'}
            </span>
        </a>
        ...
        {if $customer.addresses|count}
          ...
          {else}
            ...
            <span class="link-item">
              {l s='Додайте свою першу адресу' d='Shop.Theme.Customeraccount'}
            </span>
            </a>
        {/if}
    ...
    <div class="my-account-page-content {if $customer.is_logged}col-sm-10{else}col{/if}">

      {*block name='page_title' hide}
          <h2> 123 {$smarty.block.child}</h2>
      {/block*}
