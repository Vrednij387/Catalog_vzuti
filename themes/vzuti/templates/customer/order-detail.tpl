...
{block name='page_title'}
  {l s='Замовлення ' d='Shop.Theme.Customeraccount'}
{/block}
...
{block name='page_content'}
      ...
      <div class="box">
          <div class="row align-items-center">
            <div class="col-9">
              <h3>
                {l
                  s='Замовлення №<b>%reference%</b> від %date%'
  ...
  {block name='order_infos2'}
    <style>
      #order-detail .my-account-page-content #delivery-address {
          padding-left: 20px;
          margin: 0px 15px;
          background-color: var(--light-gray);
      }
      #order-detail .my-account-page-content strong,
      #order-detail .my-account-page-content b {
        font-weight: 500;
      }
    </style>
  <div id="order-infos2" class="box">
    <ul>
      <li>{l s='Payment method' d='Shop.Theme.Checkout'} - {$order.details.payment}</li>
      <li>{l s='Carrier' d='Shop.Theme.Checkout'} - {$order.carrier.name}</li>
