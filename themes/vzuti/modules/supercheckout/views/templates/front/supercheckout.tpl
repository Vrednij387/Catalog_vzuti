...
<style>
    .opc-container input[type=checkbox] {
        ...
        {capture name=path}
            <span class="navigation_page">{l s='Your shopping cart' mod='supercheckout'}</span>
        {/capture}
        <div id="fb-root"></div>
    ...
    box-shadow: 0 2.5em 0 0;
            ...
            {*if isset($settings['html_value']['header']) && $settings['html_value']['header'] neq ''}
                <div id="supercheckout_html_content_header">        
                    {$settings['html_value']['header'] nofilter}
            ...
            <div class="container" id="supercheckout_order_progress_bar" style="display:none;">
                <div class="row">
                    <div class="col-md-12">
                        <img class="logo img-fluid" src="/img/vzuti_anima_css.svg" alt="Vzuti" width="150%" height="">
                        <!--
            ...
            <div class="panel panel-default">
                <fieldset class="group-select" id="supercheckout-fieldset">
                    ...
                    <div class="new_cart">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12" id="cart_block">
                                {* *}
                                <h1>{l s="Оформлення замовлення"}</h1>
                                {if $logged && false}
                                    <h4 class="title section-title">
                                        {l s='Welcome' mod='supercheckout'} {$customer_name} {*<i class="fas fa-user-lock"></i>*}
                                    </h4>
                                {else}
                                    {*<p class="cart_title">Авторизація</p>*}
                                {/if}
                                ...
                                {if $show_delivery_add_for_virtualcart eq true}
                                    <p>show_delivery_add_for_virtualcart</p>
                                    <div id="checkoutShippingAddress" style="display:none;">
                                    </div>
                                {else}
                                    {*<p class="cart_title">not show_delivery_add_for_virtualcart</p>*}
                                    <div id="checkoutShippingAddress">
                                        {include file='module:supercheckout/views/templates/front/shipping_address.tpl'}
                                    </div>
                                {/if}
                                <p style="padding: 10px 20px; background-color: #f8f5eb;">Уважно перевірте номер телефону</p>


                                <h2 class="cart_title">{l s='Доставка'}</h2>

                                    {*<p class="cart_title">{l s='Метод доставки замовлення'}</p>
                                    <p>shipping_method_update_warning</p>
                                    <div id="shipping_method_update_warning" class="supercheckout-checkout-content"></div>
                                    <p>shipping-method</p>*}
                                    <div id="shipping-method"></div>

                                <h2 class="cart_title">{l s='Оплата замовлення'}</h2>
                                ...
                                <h3 class="h3">{l s='Комментар до замовлення' mod='supercheckout'}</h3>
                                    <div class="supercheckout-checkout-content"> </div>
                                    <div class="form-group" id="supercheckout-comments" style="{if $logged}{if $settings['confirm']['order_comment_box']['logged']['display'] eq 1}display:block{else}display:none{/if}{else}{if $settings['confirm']['order_comment_box']['guest']['display'] eq 1}display:block{else}display:none{/if}{/if};">
                                        <textarea id="supercheckout-comment_order" class="form-control" name="comment" placeholder="{l s='Додайте коментар, якщо потрібно ...' mod='supercheckout'}"></textarea>
                                    </div>
                                    ...
                                    <div id="placeorderButton" style="text-align: center;margin-bottom: 10px;">
                                        ...
                                        <div id="buttonWithProgres">
                                            <div  id="supercheckout_confirm_order" class="orangebutton btn btn-success" >
                                                {l s='Підтверджую замовлення' mod='supercheckout'}
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-12" id="cart_list">
                                <div class="opc_shoppingcart custom-panel">
                                    <h2 class="cart_title cart">{l s='Кошик' mod='supercheckout'}</h2>
                                    <div id="cart_update_warning" class="supercheckout-checkout-content"></div>
                                    <div id="complete_cart_summary"></div>
                                </div>

                                {if isset($HOOK_SHOPPING_CART)}
                                    <p>HOOK_SHOPPING_CART</p>
                                    <div id="loyalty_text_holder">
                                        {$HOOK_SHOPPING_CART nofilter}
                                    </div>
                                {/if}
                            </div>
                        </div>
                                ...
                                <div class="supercheckout-column-left columnleftsort checkout-section section-login custom-panel" id="columnleft-1" style="width:{100*$multiplier}%;flex:{100*$multiplier}%;max-width:{100*$multiplier}%;"> {*Need to change later*}
                                    <div  class="supercheckout-blocks"  data-column="{$settings['design']['login'][$layout_name]['column']|intval}" data-row="{$settings['design']['login'][$layout_name]['row']|intval}" data-column-inside="{$settings['design']['login'][$layout_name]['column-inside']|intval}"  >
                                        ...
                                        {if $logged}
                                            ...
                                            {else}
                                            <h2 class="title section-title">
                                                LoginOptions: {l s='Login Options' mod='supercheckout'} <i class="fas fa-user-lock"></i></h2>
                                            {/if}
                                        <div id="checkoutLogin" class="section-body">
                                            <div class="supercheckout-checkout-content"></div>
                                            {include file='module:supercheckout/views/templates/front/login.tpl'}
...
{*                                                        <option value="">{l s='Select profile' mod='supercheckout'}</option>*} 
        ...
        {*if isset($settings['html_value']['footer']) && $settings['html_value']['footer'] neq ''}
            <div id="supercheckout_html_content_footer">        
                {$settings['html_value']['footer'] nofilter}
            </div>
        {/if*}
                                ...
                                autocompleteLsr[name] = google.maps.event.addListener(autocomplete[name], 'place_changed', function () {
                                    ...
                                    for (var i = 0; i < place.address_components.length; i++) {
                                        ...
                                        if (typeof field[addressType] !== 'undefined') {
                                            ...
                                            if (Number(google_auto_address_setting_enable)) {
