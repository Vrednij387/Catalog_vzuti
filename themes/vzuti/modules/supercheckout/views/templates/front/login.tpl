    ...
    <div class="myaccount rectangle-list text-center">
        ...
        <ul class="accountOptions">
            <li class="myAccountLi">
                <a href="{$my_account_url}">1<i class="fa fa-user"></i> {l s='My Account' mod='supercheckout'}</a>
            </li>
    ...
    <div id="supercheckout-option" class="form-group login-options text-center">
        {if $settings['enable_guest_checkout'] eq 1 && $guest_enable_by_system}
            <div class="radio-inline">
                ...
                {/if}
                <label for="guest_checkout">{l s='Оформлення без реєстрації' mod='supercheckout'}</label>
            </div>
        {/if}
        <div class="radio-inline">
            ...
            {/if}
            <label for="logged_checkout" >{l s='Вхід в особистий кабінет' mod='supercheckout'}</label>
        </div>
        ...
        <div class="radio-inline">
            ...
            {/if}
            <label for="register_checkout">{l s='Зареєструватись' mod='supercheckout'}</label>
        </div>
    </div>
    ...
    <div class="login-form">
        ...
        <div id="supercheckout-login-box" class="form-group" style="display:{if $settings['checkout_option'] eq 0}block{else}none{/if};">
            <div id="supercheckout-login-password-box" class="supercheckout-extra-wrap">
                <label class="control-label" for="supercheckout_password">Пароль</label>
            ...
            <tr id="new_customer_password" class="sort_data register_type"  data-percentage="0" style="display:{if $settings['checkout_option'] eq 2}block{else}none{/if};" >
                <td style="display: block;">
                    <div class="form-group ">
                        <label class="control-label" for="customer_personal[password]">Пароль</label>
            ...
            <div class="social-login">
                ...
                {if $settings['fb_login']['enable'] eq 1}
                    {if $settings['social_login_popup']['enable'] eq 1}
                        <a onclick="return !window.open(this.href, 'popup', 'width=450,height=300,left=500,top=500')" target="_blank" href="{$supercheckout_url|escape:'quotes'}{if $supercheckout_url|strstr:"?"}&myfbLogin {else}?myfbLogin{/if}" class="fbButton btn azm-social azm-btn azm-pill azm-facebook" id="fb-auth" ><i class="fa fa-facebook"></i>  Facebook</a>
                        {*escape not required as contains url*}
                        
                    {else}
                        <a href="{$supercheckout_url|escape:'quotes'}{if $supercheckout_url|strstr:"?"}&myfbLogin {else}?myfbLogin{/if}" class="fbButton btn azm-social azm-btn azm-pill azm-facebook" id="fb-auth" ><i class="fa fa-facebook"></i> Facebook</a> 
                        {*escape not required as contains url*}
                    {/if}
                {/if}
                {*
                ...
                {if $settings['google_login']['enable'] eq 1}
                    {if $settings['social_login_popup']['enable'] eq 1}
                        <a onclick="return !window.open(this.href, 'popup', 'width=500,height=500,left=500,top=500')" target="_blank" href="{$supercheckout_url|escape:'quotes'}{if $supercheckout_url|strstr:"?"}&myGoogleLogin {else}?myGoogleLogin{/if}" class="googleButton btn azm-social azm-btn azm-pill azm-google-plus" ><i class="fab fa-google"></i> Google</a>
                        {*escape not required as contains url*}
                    {else}
                        <a href="{$supercheckout_url|escape:'quotes'}{if $supercheckout_url|strstr:"?"}&myGoogleLogin {else}?myGoogleLogin{/if}" class="googleButton btn azm-social azm-btn azm-pill azm-google-plus" ><i class="fab fa-google"></i> Google</a>
                        {*escape not required as contains url*}
                    {/if}
                {/if}
                {*
                ...
                {if $settings['paypal_login']['enable'] eq 1}
                    {if $settings['social_login_popup']['enable'] eq 1}
                        <a onclick="return !window.open(this.href, 'popup', 'width=500,height=500,left=500,top=500')" target="_blank" href="{$supercheckout_url|escape:'quotes'}{if $supercheckout_url|strstr:"?"}&myPaypalLogin {else}?myPaypalLogin{/if}" class="btn azm-social azm-btn azm-border-bottom azm-paypal" style="color: #ffffff; background: #009cde;"><i class="fa fa-paypal"></i>Login with Paypal</a>
                        {*escape not required as contains url*}
                    {else}
                        <a href="{$supercheckout_url|escape:'quotes'}{if $supercheckout_url|strstr:"?"}&myPaypalLogin {else}?myPaypalLogin{/if}"class="btn azm-social azm-btn azm-border-bottom azm-paypal" style="color: #ffffff; background: #009cde;"><i class="fa fa-paypal"></i>Login with Paypal</a>
                        {*escape not required as contains url*}
                    {/if}
                {/if}
                </div>
