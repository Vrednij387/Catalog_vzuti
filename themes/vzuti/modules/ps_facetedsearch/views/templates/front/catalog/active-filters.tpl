                        ...
                        <li class="filter-block">
                            <a class="js-search-link btn btn-secondary btn-sm" href="{$filter.nextEncodedFacetsURL}">
                               {* <i class="fa fa-times" aria-hidden="true"></i>*}
                                <img src="/themes/vzuti/assets/img/close.svg" alt="відмінити" title="Закрити" class="esc_filter">
                    ...
                    {block name='facets_clearall_button'}
                        <li class="filter-block filter-block-all">
                            <a class="js-search-link btn btn-secondary btn-sm" href="{$clear_all_link}">
                                {*<i class="fa fa-times" aria-hidden="true"></i>*}
                                <img src="/themes/vzuti/assets/img/close.svg" alt="вимкнути всі фільтри" title="вимкнути всі фільтри" class="esc_filter">
